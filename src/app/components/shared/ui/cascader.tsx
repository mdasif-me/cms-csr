...
export function Cascader({
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild disabled={disabled}>
        <div
          ...
          className={cn(
            ...
            'h-12 px-6 py-3.5 w-[200px] cursor-pointer',
      ...
      <PopoverContent
        className={cn(
          'w-auto p-0 2xl:max-w-2xl xl:max-w-xl lg:max-w-lg md:max-w-md max-w-xs overflow-auto',
          popupClassName
        )}
        align='start'
      >
        <div className='flex'>
          {columns.map((column, columnIndex) => (
            <div
              key={columnIndex}
              className={cn(
                'min-w-[200px] max-h-[300px] overflow-auto py-1',
